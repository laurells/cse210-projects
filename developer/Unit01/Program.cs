...
namespace Unit01
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("This is a game called Tic-Tac_Toe. Tic-Tac-Toe is a very simple two player game, it is also known as Noughts and Crosses.");
            Console.WriteLine("Game Rules");
            Console.Write("- The first player plays with 'X'. So you can decide who wants to go 'X' and who wants go with 'O'.");
            Console.Write("- Only one player can play at a time.");
            Console.Write("- If any of the players have filled a square then the other player and the same player cannot override that square.");
            Console.WriteLine("- The player that succeeds in placing three respective mark (X or O) in a horizontal, vertical or diagonal row wins the game.");
            Console.WriteLine("\n");
            Console.Write("Player1:X and Player2:O");
            Console.WriteLine("\n");
            
    
    /// <summary>
    /// This the code of a Tic Tac Toe program. 
    /// </summary>
